...
async function addUserDetails(userID) {
    ...
    try {
        ...
        const setUserInfoInFirestorDatabase = await setDoc(doc(db, "Postmate-Users", userID), {
...
async function loginUser() {
    try {
        ...
        if (errorMessage === "auth/user-not-found") {
            alert("Sorry! This account is not registered, kindly create an account first");
        }
    }
}